...
public class GameManager : MonoBehaviour 
{
    ...
    public void SaveAndQuit()
    {
        ...
        if (player != null)
        {
            SaveSystem.instance.Save(SceneManager.GetActiveScene().buildIndex, player.transform.position, player.CurrentHealth, elapsedTime, aliveEnemies);
        }
        else
        {
            SaveSystem.instance.Save(SceneManager.GetActiveScene().buildIndex, Vector3.zero, 100, elapsedTime, aliveEnemies);
        }
    ...
    public void WinLevel()
    {
        ...
        if (RecordSystem.instance != null)
        {
            ...
            RecordSystem.instance.TrySetRecord(scene, name, elapsedTime);
        }
    }
